...
export const strings = new LocalizedStrings({
  en: {
    ...
    titleOverconstrainedError:
      "Device does not match the hardware requirements of this application",
    descOverconstrainedError:
      "Please use use the settings menu to try to select another device.",
    ...
    descAbortError:
      "Please check is device connected properly or use the settings menu to try to select another device.",
    titleNotReadableError: "Could not access the device",
    descNotReadableError:
      "Please check is any other application using the device  or use the settings menu to try to select another device.",
    ...
    descConferenceCapacityError:
      "Conference is at the maximum capacity and is not accepting new participants.",
    ...
    descPeerNotFoundError:
      "Connection to server could not be established. Please check your network connection.",
    ...
    descCreateAnswerError:
      "The system was unable to set up your call due to a call negotiation failure. Contact your app provider for help.",
    descParticipantNotFoundError:
      "The system was unable to find the participant in your call. " +
      "Contact your app provider for help.",
    ...
    inviteUser: "Invite",
    autoPlayBlocked:
      "The browser has blocked automatic audio playback due to a security policy, proceed to start hearing audio from the conference",
    ...
    pinnedCameraOn:
      "Click icon to only view video from this participant if he/she talked",
  ...
  fr: {
    ...
    showVideoParticipants2: "participants",
    pinnedCameraOff:
      "Cliquez sur l'icône pour toujours voir la vidéo de ce participant",
    pinnedCameraOn:
      "Cliquez sur l'icône pour afficher la vidéo de ce participant uniquement s'il a parlé",
