        ...
        return (
          <div>
            <div className="vxt-conference-status">
              <a onClick={() => this.openSettings()} className={className} title="Join">
            ...
            { this.state.showSettings &&
              <div className="modal-join">
                  <div className="content">
                      ...
                      <ReactTooltip id="toggle-close" place="left" effect="solid" className="tooltip">Close</ReactTooltip>
                      {<ModalJoinSettings />}
                      ...
                      <div className="vxt-modal-join-phone">
                        <div className="vxt-conference-status">
                          <a onClick={() => this.joinConference()} className={className} title="Join">
                            { !this.props.isLive && <span className="icon-phone"></span>}
                            </a>
                        </div>
                      </div>
