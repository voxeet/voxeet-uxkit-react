...
import {
  ...
  shouldComponentUpdate as shouldRWUpdate,
} from "react-window";
  ...
  componentDidMount() {
    if (this.rowRef && this.rowRef.current && this.props.setRowHeight) {
      this.props.setRowHeight(
        this.props.index,
        this.rowRef.current.clientHeight
      );
    }
  }
            ...
            <div className="chat-container-myself">
              <div>
                ...
                {!chatOptions.autoLinker ? (
                  <div className="chat-content-myself">
                    {this.props.content}
                  </div>
                ) : (
                  <div
...
class MessageList extends Component {
  ...
  componentDidUpdate(prevProps) {
    if (
      ...
      (prevProps.attendeesChatOpened !== this.props.attendeesChatOpened &&
        this.props.attendeesChatOpened &&
