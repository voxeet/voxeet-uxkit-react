...
class AttendeesSettings extends Component {
    ...
    componentDidUpdate(nextProps, nextState) {
        if ((this.props.controlsStore.videoEnabled != nextProps.controlsStore.videoEnabled) || (this.props.controlsStore.audioEnabled != nextProps.controlsStore.audioEnabled)) {
            Sdk.instance.enumerateAudioDevices().then((devices) => {
                if (this.props.inputManager.currentAudioDevice != "") {
                    ...
                    if (!exist) {
                        ...
                        Cookies.set('input', devices[0].deviceId, { path: '/', expires: date });
                        this.props.dispatch(InputManagerActions.inputAudioChange(devices[0].deviceId))
                    }
                }
                this.setState({
            ...
            Sdk.instance.enumerateAudioDevices("output").then((devices) => {
                ...
                if (!exist) {
                    ...
                    this.props.dispatch(InputManagerActions.outputAudioChange(devices[0].deviceId))
                }
                }
                this.setState({
            ...
            Sdk.instance.enumerateVideoDevices().then((devices) => {
                if (this.props.inputManager.currentVideoDevice != "") {
                    ...
                    this.props.dispatch(InputManagerActions.inputVideoChange(devices[0].deviceId))
                    }
                }
                this.setState({
    ...
    componentWillUpdate(nextProps, nextState) {
        if (this.props.attendeesSettingsOpened == true && nextProps.attendeesSettingsOpened == false) {
    ...
    render() {
        ...
        return (
            <div className={this.state.runningAnimation ? "attendees-settings attendees-settings-out" : (attendeesSettingsOpened ? "attendees-settings": "attendees-settings-hidden")}>
