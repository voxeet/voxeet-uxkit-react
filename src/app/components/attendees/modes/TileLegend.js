...
class TileLegend extends Component {
    ...
    render() {
        const { participant, toggleMicrophone, isAdmin, kickParticipant, isAdminActived } = this.props
        return (
            <span className="tile-legend">
                ...
                <AttendeesParticipantMute participant={participant} toggleMicrophone={toggleMicrophone} />
                {
                  isAdmin && isAdminActived &&
                      <AttendeesKickParticipant isAdminActived={isAdminActived} participant={participant} kickParticipant={kickParticipant} />
                }
            </span>
        )
    }
