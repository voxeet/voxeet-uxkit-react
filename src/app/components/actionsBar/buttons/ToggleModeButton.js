        ...
        return (
            <div className="layout-container">
                <a data-tip data-for="toggle-mode"
                    onClick={() => toggleMode()} className={'icn-switch-list ' + this.getModeIcon(mode)}
                    title={strings.displaymode}>
                </a>
                <ReactTooltip id="toggle-mode" place={tooltipPlace} effect="solid" className="tooltip">{this.getModeTranslation(mode)}</ReactTooltip>
            </div>
        )
    }
}
