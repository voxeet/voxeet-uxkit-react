...
import { ToggleSidebarButton, ToggleFullScreenButton, HangupButton, CloseModalButton } from '../buttons';
...
class Sidebar extends Component {
    ...
    render() {
        const { forceFullscreen, isWidgetOpened, isWidgetFullScreenOn,
            toggleWidget, toggleFullScreen, leave } = this.props
