...
- Fixed an issue where listener and participants without streams are not visible in the conference
- Fixed an issue where switch for bokeh mode is visible in web browsers
